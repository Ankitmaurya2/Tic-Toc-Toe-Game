...
lblTitle=Label(Tops,font=("arial",50,'bold'),text='Advanced Tic Toc Toe Game',bd=21,bg='cadet Blue',fg='cornsilk',justify=CENTER)
...
def scorekeeper():
    if(button1['text']=="X" and button2['text']=="X" and button3["text"]=="X"):
     ...
     score = (n+1)
     playerX.set(score)
     massagebox.showinfo("Winner X","you have just eon a game")
    ...
    if(button4['text']=="X" and button5['text']=="X" and button6["text"]=="X"):
     ...
     score = (n+1)
     playerX.set(score)
     tkinter.massagebox.showinfo("Winner X","you have just eon a game")
    ...
    if(button1['text']=="X" and button5['text']=="X" and button9["text"]=="X"):
     button1.configure(background='gray')
     button5.configure(background='gray')
     button9.configure(background='gray')
     n = float (playerX.get())
     score = (n+1)
     playerX.set(score)
     tkinter.massagebox.showinfo("Winner X","you have just eon a game")
    ...
    if(button1['text']=="O" and button2['text']=="O" and button3["text"]=="O"):
     ...
     score = (n+1)
     playerO.set(score)
     tkinter.massagebox.showinfo("Winner O","you have just eon a game")
